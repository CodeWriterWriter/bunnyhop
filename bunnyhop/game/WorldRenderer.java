 ...
 * @brief       renders the world (creating the gui and all)
 */
...
public class WorldRenderer implements Disposable {
    ...
    private void renderGuiGameOverMessage(SpriteBatch batch) {
        ...
        if (worldController.isGameWon()) {
            BitmapFont fontGameOver = Assets.instance.fonts.defaultBig;
            fontGameOver.setColor(1, 0.75f, 0.25f, 1);
            fontGameOver.drawMultiLine(batch, "GAME WON", x, y, 0, BitmapFont.HAlignment.CENTER);
            fontGameOver.setColor(1, 1, 1, 1);
        }
    }
    ...
    private void renderGuiTimeLeft(SpriteBatch batch) {
        float x = cameraGUI.viewportWidth/2 - 70;
        float y = -15;
        ...
        if (timeLeft > 0) {
            ...
            if (timeLeft < 10) {
                if (((int) (timeLeft * 5) % 2) != 0)
                	Assets.instance.fonts.defaultBig.draw(batch, "Time Left : " + (int) timeLeft, x, y + 37);
            }
            else
            	Assets.instance.fonts.defaultBig.draw(batch, "Time Left : " + (int) timeLeft, x, y + 37);
        }
