 ...
 * @brief       deals with the bunny head (player) in the game
 */
...
public class BunnyHead extends AbstractGameObject {
    ...
    public static JUMP_STATE       jumpState;
    ...
    public void init() {
        ...
        timeLeft = Constants.TIME_GAMEPLAY;					  // Gameplay time
  }

    public void setJumping(boolean jumpKeyPressed) {
    	//Gdx.app.log(TAG, String.valueOf(jumpState));
        switch (jumpState) {
